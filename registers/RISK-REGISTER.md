...
**Focused treatment review:** 2026-08-11 — continuity/provider completion pass
...
|---|---|---|---|---|---:|---:|---|---|---|---|---|---|
| ISS-RISK-001 | Loss of sole engineering-authority availability | CURRENT | Engineering Authority; all active engineering repositories | Governance Authority | 2 | 3 | HIGH (6) | REDUCE | Focused 2026-08-11 treatment review confirmed reconstructable repository and governance state reduces context loss but does not create another authorized human operator. The current solo-project boundary may pause during sole-operator unavailability. The current continuity decision under ISS-BCP-ACT-004 is complete for this boundary; any future obligation requiring continued operation during operator unavailability triggers a new continuity or succession review. The structural sole-operator risk remains open. | 2026-11-09 | OPEN | 2026-11-09 |
...
| ISS-RISK-010 | Critical supplier or service outage | CURRENT | GitHub; Squarespace-managed domain/DNS; Gmail; other material suppliers | Governance Authority | 2 | 2 | MEDIUM (4) | REDUCE | Current provider recovery conditions were confirmed in the 2026-08-11 review; continue supplier monitoring. | 2026-11-09 | MONITORING | 2026-11-09 |
| ISS-RISK-011 | Unauthorized change or compromise of domain/DNS authority | CURRENT | `ironsignalsystems.com`; Squarespace-managed service boundary | System Owner | 2 | 2 | MEDIUM (4) | REDUCE | Squarespace administrative strong authentication and recovery were confirmed reviewed/usable; continue periodic review. | 2026-11-09 | MONITORING | 2026-11-09 |
| ISS-RISK-012 | Compromise or loss of administrative email access | CURRENT | `info@ironsignalsystems.com`; Gmail service boundary | System Owner | 2 | 2 | MEDIUM (4) | REDUCE | Administrative Gmail strong authentication and recovery were confirmed reviewed/usable; continue periodic review. | 2026-11-09 | MONITORING | 2026-11-09 |
| ISS-RISK-013 | Complete loss of local work or recovery state before remote synchronization | CURRENT | Primary development workstation; `/src` Btrfs/Snapper recovery boundary | System Owner | 2 | 2 | MEDIUM (4) | REDUCE | Current continuity review confirmed the minimum reconstruction path, no additional required non-secret local-only survival state, and reproducible Atlas development DB state; continue remote synchronization and local recovery controls. | 2026-11-09 | MONITORING | 2026-11-09 |
| ISS-RISK-014 | Compromise of GitHub organization administrative authority | CURRENT | Iron Signal Systems GitHub organization; GitHub SSH authentication authority | Security Authority | 2 | 3 | HIGH (6) | REDUCE | Focused 2026-08-10 treatment review identified the stronger GitHub secure-method enforcement condition as not enabled. The Governance Authority subsequently made an explicit current-boundary decision to defer that optional risk-reduction step until GitHub requires it or a material change triggers reassessment. Existing recovery/revocation procedures remain defined. The risk remains HIGH (6), REDUCE, OPEN and is not accepted or closed. | 2026-11-09 | OPEN | 2026-11-09 |

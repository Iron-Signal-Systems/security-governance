...
**Focused treatment review:** 2026-08-11 — Git signing authority
**Focused treatment review:** 2026-08-11 — primary development/admin workstation
**Focused treatment review:** 2026-08-11 — workstation remediation reassessment
...
| ISS-PRIV-003 | Git commit-signing authority | Produce signed Git history under trusted signing identity | Local protected signing authority controlled by the sole project operator | Sign accepted repository history and governance changes | RETAIN | Focused 2026-08-11 treatment review confirmed required non-secret signing-protection conditions and defined a replacement/transition procedure. `ISS-RISK-002` is reduced to MEDIUM and remains under monitoring; actual key replacement was not exercised. | 2026-11-09 |
| ISS-PRIV-004 | Primary ISS development workstation | sudo/root system administration | Normal user account with sudo/root elevation for administrative tasks | Install software, update the system, and perform required system administration | RETAIN | Focused 2026-08-11 remediation reassessment confirmed key-only remote administration and accountable current High-advisory dispositions. Privilege remains retained for required administration rather than routine root operation. `ISS-RISK-015` is MEDIUM and under monitoring. | 2026-11-09 |
